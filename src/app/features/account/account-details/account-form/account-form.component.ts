...
export class AccountFormComponent {
    ...
    onSubmit() {
        ...
        this._clientsService.addClientAccount({clientId: this.selectedClient()?.id, accounts})
    ...
    private updateClientDetails(accountsId: any) {
        this._clientsService.updateClientDetails({accountsId, id: this.selectedClient().id})
            .pipe(takeUntilDestroyed(this._destroyRef))
            .subscribe(() => {
