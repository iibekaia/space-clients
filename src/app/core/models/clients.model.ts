...
export enum EEffect {
  ...
  ADD_CLIENT_ACCOUNT = 'ADD_CLIENT_ACCOUNT',
  ADD_CLIENT_ACCOUNT_SUCCESS = 'ADD_CLIENT_ACCOUNT_SUCCESS',
  LOAD_CLIENT_ACCOUNTS = 'LOAD_CLIENT_ACCOUNT',
  LOAD_CLIENT_ACCOUNTS_SUCCESS = 'LOAD_CLIENT_ACCOUNT_SUCCESS',
